        ...
        for i in range(epoch):
            ...
            for batch_num, (instance, labels, ind) in enumerate(data_loader):
                ...
                if flag == 0:
                    ...
                    loss3 = self.proxy(hidden, target_classes).cuda()
                    
                    loss4 = self.contrastive_loss_fct(hidden, target_rep_des, encoder_llm.queue, labels, encoder_llm.queue_labels, self.config.device)
